	...
	<div class="card">
		<div class='row align-items-center m-4'>
			<div class='col-md'>
				...
				Bimbingan dan mahasiswa yang bapak bimbing untuk melihat mahasiswa siapa yang bapak bimbing. bapak bisa melihat di
				navigasi Bimbingan.
				<?php } elseif ($_SESSION['Status'] === 'Skripsi') { ?>
				<h2>Selamat Datang,
					<?= $_SESSION['Nama']?>. Sang Pejuang Bimbingan.</h2>
				Selamat ya karena menempuh semester akhir dimana setiap mahasiswa S1 pasti akan mengalami yang namanya Fase
				pengerjaan Bimbingan. Saat ini Pemberitahuanmu Kosong. di Navigasi Ide Bimbingan Kamu Bisa mengajukan ide Bimbingan yang
				mungkin kamu punya. jadi bersiap siaplah jika sering di <b>TOLAK</b>. Semangat untuk Bimbingan !!!
				...
				memvalidasimu jika kau sudah mulai melakukan Bimbingan ! tetep semangat ya menjalani kehidupanmu di kampus !!!
				jika kamu sudah memasuki semester akhir dan masih belum bisa mengakses ide Bimbingan. silahkan tanyakan ke fakultas
				yah.
				<?php } ?>
			</div>
			<div class='col-md-3'>
